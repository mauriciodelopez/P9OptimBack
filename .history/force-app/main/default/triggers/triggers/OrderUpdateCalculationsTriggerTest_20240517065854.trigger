...
private class OrderUpdateCalculationsTriggerTest {
    ...
    static void testOrderUpdateCalculationsTrigger() {
        ...
        System.assertEquals(true, OrderTriggerHandler.beforeUpdate(), 'beforeUpdate no se llamó correctamente');
        System.assertEquals(true, OrderTriggerHandler.afterUpdate(newOrders, oldMap)(), 'afterUpdate no se llamó correctamente');
    }
}