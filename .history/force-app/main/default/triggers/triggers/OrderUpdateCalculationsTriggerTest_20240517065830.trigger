...
private class OrderUpdateCalculationsTriggerTest {
    ...
    static void testOrderUpdateCalculationsTrigger() {
        ...
        System.assertEquals(true, OrderTriggerHandler.beforeUpdate(newOrders, oldMap)(), 'beforeUpdate no se llamó correctamente');
        System.assertEquals(true, OrderTriggerHandler.getAfterUpdateCalled(), 'afterUpdate no se llamó correctamente');
    }
}